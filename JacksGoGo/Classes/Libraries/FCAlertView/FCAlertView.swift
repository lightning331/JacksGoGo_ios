...
public class FCAlertView: UIView {
    ...
    public convenience init() {
        ...
        let frame = CGRect(origin: CGPoint.zero, size: result)
    ...
    private func setupAlertViewFrame() -> CGRect {
        ...
        alertBackground.frame = CGRect(origin: CGPoint.zero, size: self.frame.size)
    ...
    private func renderHeader(withAlertViewFrame alertViewFrame: CGRect){
        ...
        let titleLabel = UILabel(frame: CGRect(x: 15.0,
                                               ...
                                               height: 20.0))
        titleLabel.font = UIFont.JGGTitle1
        ...
        let descriptionLabel = UILabel(frame: CGRect(x: 25.0,
                                                     ...
                                                     height: 60.0))
        descriptionLabel.font = (title == nil) ? UIFont.JGGTitle2 : UIFont.JGGTitle3
    ...
    override public func draw(_ rect: CGRect) {
        ...
        if(!hideAllButtons && !hideDoneButton && numberOfButtons == 0) {
            ...
            doneButton.titleLabel!.font = UIFont.JGGTitle3
            ...
            otherButton.titleLabel?.font = UIFont.JGGTitle3
            ...
            firstButton.titleLabel?.font = UIFont.JGGTitle3
            ...
            secondButton.titleLabel?.font = UIFont.JGGTitle3
        ...
        circleLayer.path =
            UIBezierPath(ovalIn: CGRectMake(alertViewContents!.frame.size.width/2 - 30.0, -30.0, 60.0, 60.0)).cgPath
...
//        alertViewWithVector = 1
    ...
    @objc public func dismissAlertView(_ sender: Any? = nil) {
